...
- Every parameter comes from data, never guessed
- One change at a time, validated before the next
- Code is verified by execution before it ships - claims need proof
- Adaptive over hardcoded: rolling z-scores beat magic numbers

## Stack

Python | SQLite/FTS5 | TypeScript/Remotion | Linux (Ubuntu/Debian) | PowerShell | MCP | WebSockets
